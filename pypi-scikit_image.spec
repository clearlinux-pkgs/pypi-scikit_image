...
Source0  : https://files.pythonhosted.org/packages/4b/12/2337d523dc7085ef0e5a51dfde6059e7969442919aeac8de0064bdb8adb7/scikit_image-0.23.1.tar.gz
...
%prep
%setup -q -n scikit_image-0.23.1
cd %{_builddir}/scikit_image-0.23.1
pushd ..
cp -a scikit_image-0.23.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712847762
