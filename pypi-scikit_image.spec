...
Source0  : https://files.pythonhosted.org/packages/65/c1/a49da20845f0f0e1afbb1c2586d406dc0acb84c26ae293bad6d7e7f718bc/scikit_image-0.22.0.tar.gz
...
%prep
%setup -q -n scikit_image-0.22.0
cd %{_builddir}/scikit_image-0.22.0
pushd ..
cp -a scikit_image-0.22.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707139935
...
cp %{_builddir}/scikit_image-%{version}/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-scikit_image/87479c507ad4fa653912dd212a000caae459085f || :
...
/usr/share/package-licenses/pypi-scikit_image/87479c507ad4fa653912dd212a000caae459085f
