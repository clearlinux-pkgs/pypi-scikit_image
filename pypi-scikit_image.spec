...
Source0  : https://files.pythonhosted.org/packages/83/e5/496a74ccfc1206666b9c7164a16657febdfeb6df0e458cb61286b20102c9/scikit_image-0.25.1.tar.gz
...
%prep
%setup -q -n scikit_image-0.25.1
cd %{_builddir}/scikit_image-0.25.1
pushd ..
cp -a scikit_image-0.25.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737993463
