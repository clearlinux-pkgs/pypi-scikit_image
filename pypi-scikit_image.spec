...
Source0  : https://files.pythonhosted.org/packages/24/ce/183ff64ed397911a9d3b671714f8a2618af407b427a40ca48550fb0f7bd7/scikit_image-0.23.2.tar.gz
...
%prep
%setup -q -n scikit_image-0.23.2
cd %{_builddir}/scikit_image-0.23.2
pushd ..
cp -a scikit_image-0.23.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713667759
...
cp %{_builddir}/scikit_image-%{version}/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-scikit_image/43af61d3338cde5bdb69607b99bd24167fc64408 || :
...
/usr/share/package-licenses/pypi-scikit_image/43af61d3338cde5bdb69607b99bd24167fc64408
